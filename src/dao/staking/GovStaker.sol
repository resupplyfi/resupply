...
contract GovStaker is MultiRewardsDistributor, EpochTracker, DelegatedOps {
    ...
    */
     ...
     */
    function startIrreversibleStakeForAccount() external {
        pendingPermaStaker[msg.sender] = true;
        emit PendingPermaStaker(msg.sender);
    }
     ...
     */
    function commitIrreversibleStakeForAccount() external {
        require(pendingPermaStaker[msg.sender], "pending perma staker");
        pendingPermaStaker[msg.sender] = false;
        accountData[msg.sender].isPermaStaker = true;
        emit PermaStakerSet(msg.sender);
    }
