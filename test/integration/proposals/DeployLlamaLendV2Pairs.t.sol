...
contract DeployLlamaLendV2PairsTest is BaseProposalTest {
    ...
    function setUp() public override {
        ...
        (sdolaPair,) = script.getPairDeploymentAddressAndCallData(Protocol.PROTOCOL_ID_CURVE, script.SDOLA_VAULT(), address(0), 0);
        (sfrxUsdPair,) = script.getPairDeploymentAddressAndCallData(Protocol.PROTOCOL_ID_CURVE, script.SFRXUSD_VAULT(), address(0), 0);
