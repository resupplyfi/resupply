...
contract Setup is Test {
    ...
    IResupplyPair internal testPair = IResupplyPair(Mainnet.FRAXLEND_SCRVUSD_FRXUSD);
    IResupplyPair internal testPair2 = IResupplyPair(Mainnet.CURVELEND_SDOLA_CRVUSD);
