...
contract CurveProposalReplaceOperator is BaseCurveProposal {
    ...
    address public constant NEW_IMPLEMENTATION = 0xB64e295a69928d3404E576a8fF3c8766559cB8F5;
    ...
    function buildProposalScript() public override returns (bytes memory script) {
        ...
        //initially we mint 20M crvUSD (15M is our target + 5M liquidity to ensure old operator can be reduced to 0)
        actions[1] = _executeViaMintFactoryEDAOProxy(
        ...
        //reset debt ceiling to target amount of 15m
        actions[5] = _executeViaMintFactoryEDAOProxy(
            Mainnet.CURVE_CRVUSD_CONTROLLER, 
            abi.encodeWithSelector(
                ICrvusdController.set_debt_ceiling.selector, 
                Mainnet.CURVE_LENDING_FACTORY,
