...
contract DeployProxy is BaseAction {
    ...
    function printProxyDetails(address _proxy) public {
        address owner = GuardianUpgradeable(_proxy).owner();
        address impl = Upgrades.getImplementationAddress(_proxy);
        console.log("Proxy deployed at", _proxy);
